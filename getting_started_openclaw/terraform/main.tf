/*
============================================================================
stdapi.ai with OpenClaw Deployment
============================================================================
This configuration deploys stdapi.ai as a backend service (no ALB) with
OpenClaw as an autonomous-agent gateway and Control UI, accessible via ALB.

Features:
- stdapi.ai as internal OpenAI-compatible API backend
- OpenClaw gateway + Control UI (port 18789) via ALB
- Preconfigured OpenClaw provider pointing at stdapi.ai/Bedrock, seeded on
  first boot and preserved across redeploys
- Persistent OpenClaw state (config, auth, workspace) on EFS
- ECS Exec enabled for Control UI device pairing
