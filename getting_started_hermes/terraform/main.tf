/*
============================================================================
stdapi.ai with Hermes Agent Deployment
============================================================================
This configuration deploys stdapi.ai as a backend service (no ALB) with
Hermes Agent (Nous Research) as the autonomous agent gateway, accessible
via ALB.

Features:
- stdapi.ai as internal OpenAI-compatible API backend
- Hermes Agent gateway (port 8642) and web dashboard (port 9119) via ALB
- Preconfigured Hermes config.yaml pointing at stdapi.ai/Bedrock, seeded on
