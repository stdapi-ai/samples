...
============================================================================
Deploys Amazon ElastiCache for Valkey as RAGFlow's cache and task queue.

Cluster mode stays disabled and ElastiCache Serverless is not an option:
RAGFlow drives the queue with Redis Streams plus Lua scripts on database 1,
